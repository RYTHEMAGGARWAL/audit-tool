    ...
    worksheet.eachRow({ includeEmpty: false }, (row, rowNumber) => {
      if (rowNumber > 1) {
        ...
        rows.push({
          ...
          centerHeadName: getCellValue(row.getCell(5)),
          zonalHeadName: getCellValue(row.getCell(6)),
          frontOfficeScore: Number.parseFloat(getCellValue(row.getCell(7))) || 0,
          deliveryProcessScore: Number.parseFloat(getCellValue(row.getCell(8))) || 0,
          placementScore: Number.parseFloat(getCellValue(row.getCell(9))) || 0,
          managementScore: Number.parseFloat(getCellValue(row.getCell(10))) || 0,
          grandTotal: Number.parseFloat(getCellValue(row.getCell(11))) || 0,
